...
import { ArrowRight, BookOpenCheck, Radio, Sparkles, Trophy } from "lucide-react";
...
export default function Home() {
  ...
  const completedCount = passport.data?.completedIds.length ?? 0;

  return <div className="welcome-app"><EventHeader /><main className="container welcome-main">
